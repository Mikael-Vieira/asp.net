...
O objetivo principal é demonstrar como criar um e-commerce funcional com cadastro de produtos, carrinho, clientes, pedidos e interface responsiva.
...
- Carrinho funcional com atualização visual  
- Controle de pedidos e histórico  
- Sistema completo de CRUD de produtos  
- Cadastro e gerenciamento de clientes  
- Integração com banco SQL Server via Entity Framework  
...
- Estoque e data de criação automáticos  
